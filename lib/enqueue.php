...
<?php
	...
	*/
	...
	$php_css->set_selector('.sidebar a');
	$php_css->add_property('color',COLOR['white']);

	// Add multiple properties at once.
	$php_css->set_selector('.site');
	$php_css->add_property('background','#303030');
	...
	// Add multiple properties at once.
	$php_css->set_selector('.site-footer');
	$php_css->add_property('background','#303030');

	// Add multiple properties at once.
	$php_css->set_selector('.sidebar');
	$php_css->add_property('background',__utility_get_option('color_link'));

	// Add multiple properties at once.
	$php_css->set_selector('.sidebar:hover');
	$php_css->add_property('background',__utility_get_option('color_hover'));

	// Add a single property.
	$php_css->set_selector('.sidebar .widget-title');
	$php_css->add_property('color',COLOR['white']);
	...
	*/
	// Add multiple properties at once.
	$php_css->set_selector('.uk-offcanvas-bar');
	$php_css->add_property('background',__utility_get_option('color_link'));

	// Add multiple properties at once.
	$php_css->set_selector('.uk-offcanvas-bar:hover');
	$php_css->add_property('background',__utility_get_option('color_hover'));

	// Add a single property.
	$php_css->set_selector('.uk-offcanvas-bar a');
	$php_css->add_property('color',COLOR['white']);
